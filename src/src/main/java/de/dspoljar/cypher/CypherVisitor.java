...
public interface CypherVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitOC_StringOperatorExpression(CypherParser.OC_StringOperatorExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link CypherParser#oC_NullOperatorExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOC_NullOperatorExpression(CypherParser.OC_NullOperatorExpressionContext ctx);
	/**
